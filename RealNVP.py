...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        train(epoch)
        validation_loss = validate(epoch, model, valid_loader, device, writer, global_step)
    ...
    margin_uniformity(best_validation_epoch, best_model, test_loader, device, writer, global_step, prefix='Test')
