...
def validate(epoch, model, loader, device,
    ...
    for batch_idx, data in enumerate(loader):
        ...
        if 'val_loss' in current_epoch_losses:
            ...
            current_epoch_losses["val_loss"] = [current_loss]  # add current iter loss to val loss list.
...
def test(epoch, model, loader, device,
    ...
    for batch_idx, data in enumerate(loader):
        ...
        if 'test_loss' in test_dict:
            test_dict["test_loss"].append(current_loss)  # add current iter loss to test loss list.
        else:
            test_dict["test_loss"] = [current_loss]  # add current iter loss to test loss list.
