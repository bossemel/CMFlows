...
#         parser.add_argument(
#             '--n_layers', type=int, default=5, help='Number of spline layers in flow')
#         parser.add_argument(
#             '--hidden_units', type=int, default=64, help='Number of hidden units in spline layer')
#         parser.add_argument(
#             '--n_blocks', type=int, default=3, help='Number of residual blocks in each spline layer')
#         parser.add_argument(
...
#         parser.add_argument(
#             '--n_bins', type=int, default=20, help='Number of bins in piecewise spline transform')
#         parser.add_argument(
...
#         parser.add_argument(
#             '--dropout', type=float, default=0.3, help='Dropout probability in flow')
#         parser.add_argument(
...
class TrainOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            '--hidden_units_c', type=int, default=128, help='Number of hidden units in spline layer')
        parser.add_argument(
        ...
        parser.add_argument(
            '--n_bins_m', type=int, default=8, help='Number of bins in piecewise spline transform')
        parser.add_argument(
