...
from NFS_modules.nde.transforms import base
from NFS_modules.nde.transforms import normalization as norm
from NFS_modules.nde.transforms.transform_test import TransformTest
...
class BatchNormTest(TransformTest):
    ...
    def test_forward_inverse_are_consistent(self):
        ...
        inputs = torch.randn(batch_size, features)
        transforms = [
            norm.BatchNorm(features=features, affine=affine)
            for affine in [True, False]
        ]
        self.eps = 1e-6
