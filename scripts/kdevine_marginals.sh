...
# python kdevine.py \
# --exp_name kdevine_clayton_gaussian \
# --copula clayton \
# --marginal gaussian \
# --alpha 5 \
# --obs 10000 \
...
# python kdevine.py \
# --exp_name kdevine_clayton_gamma \
# --copula clayton \
# --marginal gamma \
# --alpha 5 \
# --obs 10000 \
...
# python kdevine.py \
# --exp_name kdevine_frank_gaussian \
# --copula frank \
# --marginal gaussian \
# --mu 0 \
# --var 1 \
