...
python CM_Flow.py \
--exp_name CM_Flow_Clayton_bimodal_gaussian_error_bars \
--epochs 50 \
--batch-size 100 \
--copula clayton \
...
python CM_Flow.py \
--exp_name CM_Flow_frank_bimodal_gaussian_error_bars \
--epochs 50 \
--batch-size 100 \
--copula frank \
--marginal_1 bimodal_gaussian \
...
python CM_Flow.py \
--exp_name CM_Flow_gumbel_bimodal_gaussian_error_bars \
--epochs 50 \
--batch-size 100 \
--copula gumbel \
--marginal_1 bimodal_gaussian \
