...
class TrainOptions:
    ...
    def initialize(self):
        ...
        parser.add_argument(
            '--marginal_1', default='gamma', choices=['gaussian', 'uniform', 'gamma', 'lognormal'],
            help='marginal distribution')
        parser.add_argument(
            '--marginal_2', default='gamma', choices=['gaussian', 'uniform', 'gamma', 'lognormal'],
            help='marginal distribution')
        parser.add_argument(
        ...
        # Save options
        parser.add_argument(
            '--exp_name', type=str, default='default_name_parametric', help='experiment name to store plots and logs')
        parser.add_argument(
